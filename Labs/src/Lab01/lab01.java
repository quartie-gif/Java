...
public class lab01 {
    ...
    public void exec(){
                ...
                boolean abecadlowe = String.czy_abecadlowe("abcdef");
                if (abecadlowe) punkty = punkty + 0.5;
                System.out.println("czy_abecadlowe(\"abcdef\") = " + abecadlowe);

                abecadlowe = String.czy_abecadlowe("zebra");
                if (!abecadlowe) punkty = punkty + 0.5;
                ...
                System.out.println(String.rot13("Why did the chicken cross the road?"));
                System.out.println(String.rot13("Gb trg gb gur bgure fvqr!"));
